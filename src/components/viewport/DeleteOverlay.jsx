  ...
  return (
    <g onClick={(e) => e.stopPropagation()}>
      {parts.map((part) => {
        ...
        // Tight hit target; the actual selection is resolved by handleDown
        // (nearest piece to the cursor), so overlapping targets no longer
        // cause mis-selection when zoomed in.
        const hitProps = {
          fill: '#000',
          fillOpacity: 0,
          stroke: '#000',
