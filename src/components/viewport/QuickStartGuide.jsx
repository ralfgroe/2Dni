      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '48px 32px 80px' }}>
        ...
        <Section number="12" title="Tips & Tricks">
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 4 }}>
            ...
            <Tip>The <B>Floorplan</B> node draws multiple disconnected walls in one node — press <B>Enter</B> to start a fresh wall run — and dimensions them in place: switch to <B>Dimension</B> mode, work in <B>meters</B> at a chosen scale, and type values to drive the walls. Switch <B>Wall Style</B> to <B>Double-line</B> for presentation.</Tip>
